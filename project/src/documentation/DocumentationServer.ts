        ...
        tools: [
          {
            ...
            inputSchema: require('zod').object({
              ...
              formats: require('zod')
                .array(require('zod').enum(['markdown', 'html', 'json']))
                .optional(),
...
- export-documentation: Export documentation to archive`
      ...
      switch (request.method) {
        case 'generate-project-docs':
          return this.createSuccessResponse(
            request.id,
            await this.generateProjectDocs(request.params || {})
          )
        case 'generate-api-docs':
          return this.createSuccessResponse(
            request.id,
            await this.generateAPIDocs(request.params || {})
          )
        case 'generate-architecture-diagram':
          return this.createSuccessResponse(
            request.id,
            await this.generateArchitectureDiagram(request.params || {})
          )
        case 'generate-code-documentation':
          return this.createSuccessResponse(
            request.id,
            await this.generateCodeDocumentation(request.params || {})
          )
        case 'get-docs-history':
          return this.createSuccessResponse(
            request.id,
            await this.getDocsHistory(request.params || {})
          )
        case 'compare-docs-versions':
          return this.createSuccessResponse(
            request.id,
            await this.compareDocsVersions(request.params || {})
          )
        case 'revert-docs-version':
          return this.createSuccessResponse(
            request.id,
            await this.revertDocsVersion(request.params || {})
          )
        case 'list-documentation':
          return this.createSuccessResponse(
            request.id,
            await this.listDocumentation(request.params || {})
          )
        case 'get-documentation':
          return this.createSuccessResponse(
            request.id,
            await this.getDocumentation(request.params || {})
          )
        case 'update-documentation':
          return this.createSuccessResponse(
            request.id,
            await this.updateDocumentation(request.params || {})
          )
        case 'delete-documentation':
          return this.createSuccessResponse(
            request.id,
            await this.deleteDocumentation(request.params || {})
          )
        case 'convert-documentation':
          return this.createSuccessResponse(
            request.id,
            await this.convertDocumentation(request.params || {})
          )
        case 'export-documentation':
          return this.createSuccessResponse(
            request.id,
            await this.exportDocumentation(request.params || {})
          )
        default:
  ...
  private async generateAPIDocs(args: any): Promise<any> {
    const { apiPath, format = 'markdown', includeExamples = true, outputPath } = args
  ...
  private async generateArchitectureDiagram(args: any): Promise<any> {
    const { projectPath, diagramType = 'component', format = 'svg', outputPath } = args
  ...
  private async generateCodeDocumentation(args: any): Promise<any> {
    const { filePath, format = 'markdown', includeTests = false, outputPath } = args
  ...
  private async getDocsHistory(args: any): Promise<any> {
    ...
    try {
      ...
      const history = await this.versionControl.getDocumentationHistory(projectPath, limit)
  ...
  private async revertDocsVersion(args: any): Promise<any> {
    ...
    try {
      ...
      const result = await this.versionControl.revertDocumentationVersion(projectPath, version)
  ...
  private async listDocumentation(args: any): Promise<any> {
    ...
    try {
      ...
      const documentation = await this.docGenerator.listDocumentation(projectPath, type)
  ...
  private async getDocumentation(args: any): Promise<any> {
    ...
    try {
      ...
      const documentation = await this.docGenerator.getDocumentation(docId, format)
  ...
  private async updateDocumentation(args: any): Promise<any> {
    ...
    try {
      ...
      const updated = await this.docGenerator.updateDocumentation(docId, content, format)
  ...
  private async exportDocumentation(args: any): Promise<any> {
    ...
    try {
      ...
      const exported = await this.docGenerator.exportDocumentation(docIds, format, outputPath)
