        ...
        messages: [
          {
            role: 'system',
            content:
              'You are an expert software engineer specializing in code analysis and refactoring. Provide structured, actionable feedback in JSON format when requested.',
          },
          {
            role: 'user',
            content: prompt,
