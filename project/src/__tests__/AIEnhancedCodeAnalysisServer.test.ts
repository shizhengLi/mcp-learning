...
describe('AI-Enhanced CodeAnalysisServer Integration Tests', () => {
  ...
  describe('AI Model Integration', () => {
    it(
      'should initialize AI model manager without errors',
      async () => {
    ...
    it(
      'should handle AI analysis tool calls gracefully',
      async () => {
        server = new CodeAnalysisServer(false)
...
print(f"Result: {result}")
    ...
    it(
      'should provide fallback when AI models are unavailable',
      async () => {
...
function calculateTotal(items) {
  ...
  describe('AI Analysis Tool Features', () => {
    it(
      'should format AI analysis results correctly',
      async () => {
        server = new CodeAnalysisServer(false)
        ...
        const mockAIInsights = {
          ...
          insights:
            'The code follows good practices but could benefit from modern Python features.',
        }
    ...
    it(
      'should handle AI-only analysis mode',
      async () => {
        server = new CodeAnalysisServer(false)
        ...
        const formatted = (server as any).formatAIAnalysisResult(null, mockAIInsights, {
          traditional: false,
          ai: true,
        })
    ...
    it(
      'should handle traditional-only analysis mode',
      async () => {
        server = new CodeAnalysisServer(false)
        ...
        const formatted = (server as any).formatAIAnalysisResult(mockTraditionalResult, null, {
          traditional: true,
          ai: false,
        })
  ...
  describe('Performance and Reliability', () => {
    it(
      'should handle concurrent AI analysis requests',
      async () => {
        server = new CodeAnalysisServer(false)
    ...
    it(
      'should handle large code files with AI analysis',
      async () => {
        server = new CodeAnalysisServer(false)

        // Generate a large code file with more than 1000 lines
        const largeCode = Array(150)
          .fill(
            (index: number) => `
...
def invalid_function(
  ...
  describe('Integration with Existing Features', () => {
    it(
      'should maintain compatibility with existing analysis tools',
      async () => {
        server = new CodeAnalysisServer(false)
...
def calculate_average(numbers):
    ...
    it(
      'should preserve existing formatting functionality',
      async () => {
        server = new CodeAnalysisServer(false)
