...
describe('BaseMetricsCollector', () => {
  ...
  describe('Timer Metrics', () => {
    ...
    it('should also create histogram for timer', () => {
      ...
      const histogram = metricsCollector
        .getMetrics()
        .find(m => m.name === 'test_timer' && m.type === 'histogram') as any
  ...
  describe('Histogram Metrics', () => {
    it('should record histogram value', () => {
      ...
      const histogram = metrics.find(
        m => m.name === 'test_histogram' && m.type === 'histogram'
      ) as any
      expect(histogram).toBeDefined()
    ...
    it('should aggregate multiple histogram values', () => {
      ...
      const histogram = metricsCollector
        .getMetrics()
        .find(m => m.name === 'test_histogram' && m.type === 'histogram') as any
