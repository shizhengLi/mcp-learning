...
export interface AnalysisOptions {
  ...
  thresholds?:
    | {
        ...
        maintainability?:
          | number
          | { poor: number; fair: number; good: number; excellent: number }
          | undefined
        coverage?:
          | number
          | { poor: number; fair: number; good: number; excellent: number }
    ...
    if (options.thresholds) {
      if (options.thresholds.complexity !== undefined) {
        const complexityValue =
          typeof options.thresholds.complexity === 'number'
      ...
      if (options.thresholds.maintainability !== undefined) {
        const maintainabilityValue =
          typeof options.thresholds.maintainability === 'number'
      ...
      if (options.thresholds.coverage !== undefined) {
        const coverageValue =
          typeof options.thresholds.coverage === 'number'
